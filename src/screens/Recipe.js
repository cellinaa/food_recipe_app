...
const Recipe = ({ navigation, route }) => {
  ...
  function renderRecipeCreatorCard() {
    return (
      <Animated.View
        style={{
          position: 'absolute',
        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <Image
                source={{
                  uri: selectedRecipe?.author?.profilePic,
                }}
                style={{
                  width: 40,
                  height: 40,
  ...
  function renderRecipeHeaderBar() {
    return (
      <View
        style={{
          position: 'absolute',
        ...
        <Animated.View
          style={{
            ...
            paddingBottom: 15,
            opacity: scrollY.interpolate({
              inputRange: [HEADER_HEIGHT - 110, HEADER_HEIGHT - 70],
              outputRange: [0, 1],
            }),
            transform: [
              {
